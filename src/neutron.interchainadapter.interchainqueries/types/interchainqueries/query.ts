...
export const protobufPackage = "neutron.interchainadapter.interchainqueries";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchainqueries.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  RegisteredQueries(request: QueryRegisteredQueriesRequest): Promise<QueryRegisteredQueriesResponse> {
    const data = QueryRegisteredQueriesRequest.encode(request).finish();
    const promise = this.rpc.request("neutron.interchainadapter.interchainqueries.Query", "RegisteredQueries", data);
  ...
  RegisteredQuery(request: QueryRegisteredQueryRequest): Promise<QueryRegisteredQueryResponse> {
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchainqueries.Query", "RegisteredQuery", data);
  ...
  QueryResult(request: QueryRegisteredQueryResultRequest): Promise<QueryRegisteredQueryResultResponse> {
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchainqueries.Query", "QueryResult", data);
  ...
  LastRemoteHeight(request: QueryLastRemoteHeight): Promise<QueryLastRemoteHeightResponse> {
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchainqueries.Query", "LastRemoteHeight", data);
