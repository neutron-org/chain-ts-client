...
export const QueryTotalBurnedNeutronsAmountRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryTotalBurnedNeutronsAmountRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(_: QueryTotalBurnedNeutronsAmountRequest): unknown {
    const obj: any = {};
    return obj;
  },
...
function createBaseQueryTotalBurnedNeutronsAmountResponse(): QueryTotalBurnedNeutronsAmountResponse {
  return { totalBurnedNeutronsAmount: undefined };
}
...
export const QueryTotalBurnedNeutronsAmountResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryTotalBurnedNeutronsAmountResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QueryTotalBurnedNeutronsAmountResponse {
    return {
      totalBurnedNeutronsAmount: isSet(object.totalBurnedNeutronsAmount)
        ? TotalBurnedNeutronsAmount.fromJSON(object.totalBurnedNeutronsAmount)
        : undefined,
    };
  },

  toJSON(message: QueryTotalBurnedNeutronsAmountResponse): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<QueryTotalBurnedNeutronsAmountResponse>, I>>(
    ...
    message.totalBurnedNeutronsAmount =
      (object.totalBurnedNeutronsAmount !== undefined && object.totalBurnedNeutronsAmount !== null)
        ? TotalBurnedNeutronsAmount.fromPartial(object.totalBurnedNeutronsAmount)
        : undefined;
    return message;
  },
};
