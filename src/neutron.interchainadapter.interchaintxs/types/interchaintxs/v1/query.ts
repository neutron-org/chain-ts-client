...
export const protobufPackage = "neutron.interchainadapter.interchaintxs";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchaintxs.Query", "Params", data);
  ...
  InterchainAccountAddress(
    ...
    const promise = this.rpc.request("neutron.interchainadapter.interchaintxs.Query", "InterchainAccountAddress", data);
